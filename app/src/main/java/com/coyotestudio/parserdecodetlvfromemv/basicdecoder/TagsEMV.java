 ...
 */
public class TagsEMV {

    private HashMap<String, String> tagsDictionary;
    public static final String UNKNOWN = "Unknown tag";
    ...
    public String getTagInfo(String tag) {
        String value = tagsDictionary.get(tag) != null ? tagsDictionary.get(tag) : UNKNOWN;
        return value;
    }
